  ...
  theme: {
    extend: {      
      ...
      animation: {
        ...
        'custom-float': 'customFloat 4s ease-in-out infinite',
        'custom-float2': 'customFloat2 5s ease-in-out infinite',
        'custom-float3': 'customFloat3 4.5s ease-in-out infinite',
